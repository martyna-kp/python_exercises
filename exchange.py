# Define all the functions to calculate currency exchange rates and values here.
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    rate_with_spread = exchange_rate * (spread/100)
    return (budget / (rate_with_spread + exchange_rate)) // denomination * denomination